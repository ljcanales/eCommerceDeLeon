...
public class DetallePedidoDAO {
    ...
    public List<Map<String,Object>> getDetallesPedido(int idPedido) {
        String queryStatement = "SELECT producto.id_producto, nombre, cantidad, precio FROM DetallePedido JOIN Producto ON DetallePedido.id_producto = Producto.id_producto WHERE ID_PEDIDO = :id_pedido;";
